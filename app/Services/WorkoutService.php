...
class WorkoutService
{
    ...
    private function makeUpperBodyWorkouts($coefficient, $user, $plan,)
    {
        ...
        $this->makeExercise("Regular push ups", "Do regular push ups", $workout_id, $user->id, 6, 3, null, $coefficient, -1);
        $this->makeExercise("Tricep Dips", "Do tricep Dips", $workout_id, $user->id, 6, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Planks", "Do planks", $workout_id, $user->id, null, null, 60, $coefficient, 1);
        $this->makeExercise("Crunches", "Do crunches", $workout_id, $user->id, 12, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Superman", "Do Superman", $workout_id, $user->id, 12, 3, null, $coefficient, -1);
        $this->makeExercise("Diamond push ups", "Do diamond push ups", $workout_id, $user->id, 6, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Regular push ups", "Do regular push ups", $workout_id, $user->id, 8, 3, null, $coefficient, -1);
        $this->makeExercise("Tricep Dips", "Do tricep Dips", $workout_id, $user->id, 8, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Planks", "Do planks", $workout_id, $user->id, null, null, 70, $coefficient, 1);
        $this->makeExercise("Crunches", "Do crunches", $workout_id, $user->id, 14, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Superman", "Do Superman", $workout_id, $user->id, 14, 3, null, $coefficient, -1);
        $this->makeExercise("Diamond push ups", "Do diamond push ups", $workout_id, $user->id, 8, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Regular push ups", "Do regular push ups", $workout_id, $user->id, 9, 3, null, $coefficient, -1);
        $this->makeExercise("Tricep Dips", "Do tricep Dips", $workout_id, $user->id, 9, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Planks", "Do planks", $workout_id, $user->id, null, null, 75, $coefficient, 1);
        $this->makeExercise("Crunches", "Do crunches", $workout_id, $user->id, 15, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Superman", "Do Superman", $workout_id, $user->id, 15, 3, null, $coefficient, -1);
        $this->makeExercise("Diamond push ups", "Do diamond push ups", $workout_id, $user->id, 9, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Regular push ups", "Do regular push ups", $workout_id, $user->id, 10, 3, null, $coefficient, -1);
        $this->makeExercise("Tricep Dips", "Do tricep Dips", $workout_id, $user->id, 10, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Planks", "Do planks", $workout_id, $user->id, null, null, 80, $coefficient, 1);
        $this->makeExercise("Crunches", "Do crunches", $workout_id, $user->id, 16, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Superman", "Do Superman", $workout_id, $user->id, 16, 3, null, $coefficient, -1);
        $this->makeExercise("Diamond push ups", "Do diamond push ups", $workout_id, $user->id, 10, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Regular push ups", "Do regular push ups", $workout_id, $user->id, 11, 3, null, $coefficient, -1);
        $this->makeExercise("Tricep Dips", "Do tricep Dips", $workout_id, $user->id, 11, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Planks", "Do planks", $workout_id, $user->id, null, null, 85, $coefficient, 1);
        $this->makeExercise("Crunches", "Do crunches", $workout_id, $user->id, 17, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Superman", "Do Superman", $workout_id, $user->id, 17, 3, null, $coefficient, -1);
        $this->makeExercise("Diamond push ups", "Do diamond push ups", $workout_id, $user->id, 11, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Regular push ups", "Do regular push ups", $workout_id, $user->id, 12, 3, null, $coefficient, -1);
        $this->makeExercise("Tricep Dips", "Do tricep Dips", $workout_id, $user->id, 12, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Planks", "Do planks", $workout_id, $user->id, null, null, 90, $coefficient, 1);
        $this->makeExercise("Crunches", "Do crunches", $workout_id, $user->id, 18, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Superman", "Do Superman", $workout_id, $user->id, 18, 3, null, $coefficient, -1);
        $this->makeExercise("Diamond push ups", "Do diamond push ups", $workout_id, $user->id, 12, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Regular push ups", "Do regular push ups", $workout_id, $user->id, 10, 4, null, $coefficient, -1);
        $this->makeExercise("Tricep Dips", "Do tricep Dips", $workout_id, $user->id, 10, 4, null, $coefficient, -1);
        ...
        $this->makeExercise("Planks", "Do planks", $workout_id, $user->id, null, null, 90, $coefficient, 1);
        $this->makeExercise("Crunches", "Do crunches", $workout_id, $user->id, 14, 4, null, $coefficient, -1);
        ...
        $this->makeExercise("Superman", "Do Superman", $workout_id, $user->id, 14, 4, null, $coefficient, -1);
        $this->makeExercise("Diamond push ups", "Do diamond push ups", $workout_id, $user->id, 10, 4, null, $coefficient, -1);
        ...
        $this->makeExercise("Regular push ups", "Do regular push ups", $workout_id, $user->id, 12, 4, null, $coefficient, -1);
        $this->makeExercise("Diamond push ups", "Do diamond push ups", $workout_id, $user->id, 12, 4, null, $coefficient, -1);
        $this->makeExercise("Crunches", "Do crunches", $workout_id, $user->id, 16, 4, null, $coefficient, -1);
    ...
    private function makeLowerBodyWorkouts($coefficient, $user, $plan, $is_default)
    {
        ...
        $this->makeExercise("Regular Regular squats", "Do regular squats", $workout_id, $user->id, 6, 3, null, $coefficient, -1);
        $this->makeExercise("Sumo squats", "Do sumo squats", $workout_id, $user->id, 6, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Regular squats", "Do regular squats", $workout_id, $user->id, 6, 3, null, $coefficient, -1);
        $this->makeExercise("Bulgarian split squat", "Do bulgarian split squat", $workout_id, $user->id, 6, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Glute Bridges", "Do glute bridges", $workout_id, $user->id, 6, 3, null, $coefficient, -1);
        $this->makeExercise("Squat Jumps", "Do squat jumps", $workout_id, $user->id, 6, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Regular Regular squats", "Do regular squats", $workout_id, $user->id, 7, 3, null, $coefficient, -1);
        $this->makeExercise("Sumo squats", "Do sumo squats", $workout_id, $user->id, 7, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Regular squats", "Do regular squats", $workout_id, $user->id, 7, 3, null, $coefficient, -1);
        $this->makeExercise("Bulgarian split squat", "Do bulgarian split squat", $workout_id, $user->id, 7, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Glute Bridges", "Do glute bridges", $workout_id, $user->id, 7, 3, null, $coefficient, -1);
        $this->makeExercise("Squat Jumps", "Do squat jumps", $workout_id, $user->id, 7, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Regular Regular squats", "Do regular squats", $workout_id, $user->id, 8, 3, null, $coefficient, -1);
        $this->makeExercise("Sumo squats", "Do sumo squats", $workout_id, $user->id, 8, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Regular squats", "Do regular squats", $workout_id, $user->id, 8, 3, null, $coefficient, -1);
        $this->makeExercise("Bulgarian split squat", "Do bulgarian split squat", $workout_id, $user->id, 8, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Glute Bridges", "Do glute bridges", $workout_id, $user->id, 8, 3, null, $coefficient, -1);
        $this->makeExercise("Squat Jumps", "Do squat jumps", $workout_id, $user->id, 8, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Regular Regular squats", "Do regular squats", $workout_id, $user->id, 9, 3, null, $coefficient, -1);
        $this->makeExercise("Sumo squats", "Do sumo squats", $workout_id, $user->id, 9, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Regular squats", "Do regular squats", $workout_id, $user->id, 9, 3, null, $coefficient, -1);
        $this->makeExercise("Bulgarian split squat", "Do bulgarian split squat", $workout_id, $user->id, 9, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Glute Bridges", "Do glute bridges", $workout_id, $user->id, 9, 3, null, $coefficient, -1);
        $this->makeExercise("Squat Jumps", "Do squat jumps", $workout_id, $user->id, 9, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Regular Regular squats", "Do regular squats", $workout_id, $user->id, 10, 3, null, $coefficient, -1);
        $this->makeExercise("Sumo squats", "Do sumo squats", $workout_id, $user->id, 10, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Regular squats", "Do regular squats", $workout_id, $user->id, 10, 3, null, $coefficient, -1);
        $this->makeExercise("Bulgarian split squat", "Do bulgarian split squat", $workout_id, $user->id, 10, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Glute Bridges", "Do glute bridges", $workout_id, $user->id, 10, 3, null, $coefficient, -1);
        $this->makeExercise("Squat Jumps", "Do squat jumps", $workout_id, $user->id, 10, 3, null, $coefficient, -1);
        ...
        $this->makeExercise("Regular Regular squats", "Do regular squats", $workout_id, $user->id, 8, 4, null, $coefficient, -1);
        $this->makeExercise("Sumo squats", "Do sumo squats", $workout_id, $user->id, 8, 4, null, $coefficient, -1);
        ...
        $this->makeExercise("Regular squats", "Do regular squats", $workout_id, $user->id, 8, 4, null, $coefficient, -1);
        $this->makeExercise("Bulgarian split squat", "Do bulgarian split squat", $workout_id, $user->id, 8, 4, null, $coefficient, -1);
        ...
        $this->makeExercise("Glute Bridges", "Do glute bridges", $workout_id, $user->id, 8, 4, null, $coefficient, -1);
        $this->makeExercise("Squat Jumps", "Do squat jumps", $workout_id, $user->id, 8, 4, null, $coefficient, -1);
        ...
        $this->makeExercise("Regular Regular squats", "Do regular squats", $workout_id, $user->id, 9, 4, null, $coefficient, -1);
        $this->makeExercise("Sumo squats", "Do sumo squats", $workout_id, $user->id, 9, 4, null, $coefficient, -1);
        ...
        $this->makeExercise("Regular squats", "Do regular squats", $workout_id, $user->id, 9, 4, null, $coefficient, -1);
        $this->makeExercise("Bulgarian split squat", "Do bulgarian split squat", $workout_id, $user->id, 9, 4, null, $coefficient, -1);
        ...
        $this->makeExercise("Glute Bridges", "Do glute bridges", $workout_id, $user->id, 9, 4, null, $coefficient, -1);
        $this->makeExercise("Squat Jumps", "Do squat jumps", $workout_id, $user->id, 9, 4, null, $coefficient, -1);
    ...
    private function makeExercise($name, $description, $workout_id, $user_id, $reps, $sets, $duration,  $coefficient, $duration_type)
    {
